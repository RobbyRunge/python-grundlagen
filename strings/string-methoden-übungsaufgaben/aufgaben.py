...
print(passwort1.zfill(8))                 # Ausgabe: 00abc123
print(passwort2.strip())                  # Ausgabe: Pass Wort
print(len(passwort3))                     # Ausgabe: 12
...
print(passwort3.find(2+2))                # Ausgabe: TypeError
